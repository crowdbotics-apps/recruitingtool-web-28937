...
## Project Structure
    ...
    ├── recruitingtool_web_28937  # Django project configurations
...
1. Clone this repo and `cd recruitingtool_web_28937`
...
2. Clone this repo and `cd recruitingtool_web_28937`
